...
const Taskinfocard = ({ taskInfo }: {
    ...
    function calculateTimeTaken(task: Task): string {
        ...
        return formatTimeDifference(estimatedDate, now);
      }
      ...
      function calculateTimeLeft(task: Task): string {
        ...
        return formatTimeDifference(now, estimatedDate);
      }
    ...
    return (
        ...
        <div className='bg-white w-80  rounded-2xl p-4 py-2 mt-3 h-[460px]'>
            {!taskInfo && <Cardskeleton />}
            {taskInfo && <>
                <div className=' flex justify-between items-center'>
                    <p className='font-bold '>Task Info</p>
                    <img src={editicon} alt="" className=' w-5 hover:w-6 duration-150' />
                </div>
                ...
                <div className='w-full h-28 mt-3 rounded-2xl p-3 bg-blue-100 '>
                    ...
                    <div className='flex gap-4'>
                        ...
                        <div>
                        <p className='mt-2'><span>{calculateTimeLeft({deadLine: taskInfo?.deadLine, estimate: taskInfo?.estimate})}</span> left</p>
